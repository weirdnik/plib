...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profile_user', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='django_user_set', unique=True, to=orm['auth.User'])),
            ('love', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('icbm', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('sex', self.gf('django.db.models.fields.CharField')(default='o', max_length=1)),
            ...
            ('background_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('background_width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('private', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('profile', ['User'])

        # Adding M2M table for field watches on 'User'
        db.create_table('profile_user_watches', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_user', models.ForeignKey(orm['profile.user'], null=False)),
            ('to_user', models.ForeignKey(orm['profile.user'], null=False))
        ))
        db.create_unique('profile_user_watches', ['from_user_id', 'to_user_id'])

        # Adding M2M table for field ignores on 'User'
        db.create_table('profile_user_ignores', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_user', models.ForeignKey(orm['profile.user'], null=False)),
            ('to_user', models.ForeignKey(orm['profile.user'], null=False))
        ))
        db.create_unique('profile_user_ignores', ['from_user_id', 'to_user_id'])

        # Adding M2M table for field watches_tags on 'User'
        db.create_table('profile_user_watches_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm['profile.user'], null=False)),
            ('tag', models.ForeignKey(orm['cockpit.tag'], null=False))
        ))
        db.create_unique('profile_user_watches_tags', ['user_id', 'tag_id'])

        # Adding M2M table for field ignores_tags on 'User'
        db.create_table('profile_user_ignores_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm['profile.user'], null=False)),
            ('tag', models.ForeignKey(orm['cockpit.tag'], null=False))
        ))
        db.create_unique('profile_user_ignores_tags', ['user_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field watches on 'User'
        db.delete_table('profile_user_watches')

        # Removing M2M table for field ignores on 'User'
        db.delete_table('profile_user_ignores')

        # Removing M2M table for field watches_tags on 'User'
        db.delete_table('profile_user_watches_tags')

        # Removing M2M table for field ignores_tags on 'User'
        db.delete_table('profile_user_ignores_tags')
