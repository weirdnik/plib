...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Status'
        db.create_table('cockpit_status', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender_set', to=orm['profile.User'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='recipient_set', null=True, to=orm['profile.User'])),
            ('private', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tagged', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('action', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ))
        db.send_create_signal('cockpit', ['Status'])

        # Adding model 'Tag'
        db.create_table('cockpit_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('cockpit', ['Tag'])

        # Adding M2M table for field status on 'Tag'
        db.create_table('cockpit_tag_status', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tag', models.ForeignKey(orm['cockpit.tag'], null=False)),
            ('status', models.ForeignKey(orm['cockpit.status'], null=False))
        ))
        db.create_unique('cockpit_tag_status', ['tag_id', 'status_id'])

        # Adding model 'Like'
        db.create_table('cockpit_like', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['profile.User'], unique=True)),
        ))
        db.send_create_signal('cockpit', ['Like'])

        # Adding M2M table for field status on 'Like'
        db.create_table('cockpit_like_status', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('like', models.ForeignKey(orm['cockpit.like'], null=False)),
            ('status', models.ForeignKey(orm['cockpit.status'], null=False))
        ))
        db.create_unique('cockpit_like_status', ['like_id', 'status_id'])


    def backwards(self, orm):
        # Deleting model 'Status'
        db.delete_table('cockpit_status')

        # Deleting model 'Tag'
        db.delete_table('cockpit_tag')

        # Removing M2M table for field status on 'Tag'
        db.delete_table('cockpit_tag_status')

        # Deleting model 'Like'
        db.delete_table('cockpit_like')

        # Removing M2M table for field status on 'Like'
        db.delete_table('cockpit_like_status')
    ...
    models = {
        ...
        'cockpit.like': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['profile.User']", 'unique': 'True'})
        },
        'cockpit.status': {
